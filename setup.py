...
#
#     from lupin import metadata
#
# However, when we do this, we also import `lupin/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'lupin_cli = lupin.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'lupin_gui = lupin.gui:entry_point'
        # ]
    }
)
